...
const PropertyDetails = () => {
    ...
    const response = window.confirm(
            "Esti sigur ca vrei sa stergi aceasta proprietate ?",
        );
        if (response) {
            mutate(
                {
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <CustomButton
                                title={!isCurrentUser ? "Mesaj" : "Editeaza"}
                            ...
                            />
                            <CustomButton
                                title={!isCurrentUser ? "Suna" : "Sterge"}
                                backgroundColor={
